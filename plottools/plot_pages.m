...
draw_page(page_funs, 1);


function draw_page(page_funs, page_num)
npages = length(page_funs);

if nargin(page_funs{page_num}) > 0
  warning(sprintf('Cannot draw to page %d. Invalid drawing function: %s.', ...
...
uicontrol('Parent', h_panel, 'Style', 'pushbutton', 'String', 'First', ...
    ...
    'Callback', @(a,b) draw_page(page_funs, 1));
pos(1) = pos(1) + pos(3);
uicontrol('Parent', h_panel, 'Style', 'pushbutton', 'String', 'Prev', ...
    'Tag', mfilename, ...
    'Units', 'pixels', 'Position', pos, ...
    'Callback', @(a,b) draw_page(page_funs, page_num - 1), ...
...
uicontrol('Parent', h_panel, 'Style', 'edit', 'String', page_num, ...
    'Tag', mfilename, ...
    'Units', 'pixels', 'Position', pos, ...
    'Callback', @(a,b) draw_page(page_funs, ...
...
uicontrol('Parent', h_panel, 'Style', 'pushbutton', 'String', 'Last', ...
    'Tag', mfilename, ...
    'Units', 'pixels', 'Position', pos, ...
    'Callback', @(a,b) draw_page(page_funs, npages));
